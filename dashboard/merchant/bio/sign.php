        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-bio">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="sign.php">Signature</a></li>
              </ul>
            </div>
          </li>
        </ul>
            ...
            <div class="col-md-6 col-md-3">
              <div class="card">
                ...
                <form class="forms-sample" action="upload.php" method="POST" enctype="multipart/form-data">
                  ...
                  <img src="uploads/101.jpg" style="width:55%;">
                  <br>
                  <input type="file" name="the_file" id="fileToUpload">
                  <br><br>
                  <input type="submit" name="submit" class="btn btn-primary mr-2" value="Upload">
                  </form>
                </div>
              </div>
            </div>
